...
class cfgVehicles
{
	...
	class Boots_Admin: Inventory_Base
	{
		...
		itemSize[]={2,2};
		descriptionShort="Admin Feet of invisability originally created and distributed by Pope";
		model="\invisible_mod\invisible.p3d";
		inventorySlot="Feet";
		itemInfo[]=
		{
			"Clothing",
	...
	class Pants_Admin: HunterPants_ColorBase
	{
		...
		descriptionShort="Admin Pants of invisability originally created and distributed by Pope";
		scope=2;
		visibilityModifier=0;
		hiddenSelectionsTextures[]=
		{
			"#(argb,8,8,3)color(1,1,1,0.3,ca)",
			"Invisible_mod\Data\Invisible_ca.paa",
			"Invisible_mod\Data\Invisible_ca.paa"
		};
	};
	...
	class Top_Admin: GorkaEJacket_ColorBase
	{
		...
		descriptionShort="Admin Top of invisability originally created and distributed by Pope";
		scope=2;
		visibilityModifier=0;
		hiddenSelectionsTextures[]=
		{
	...
	class Arms_Admin: Inventory_Base
	{
		...
		itemSize[]={2,2};
		descriptionShort="Admin Arms of invisability originally created and distributed by Pope";
		model="\invisible_mod\invisible.p3d";
	...
	class Head_Admin: Inventory_Base
	{
		...
		itemSize[]={2,2};
		descriptionShort="Admin Head of invisability originally created and distributed by Pope";
		model="\invisible_mod\invisible.p3d";
		inventorySlot="Head";
		simulation="head";
	};
	...
	class Backpack_Admin: AliceBag_ColorBase
	{
		...
		descriptionShort="Admin Backpack of invisability originally created and distributed by Pope";
		scope=2;
		visibilityModifier=0;
